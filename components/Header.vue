    ...
    <nav class="flex flex-row items-center justify-between max-w-[1400px] mx-auto">
      <div
        ...
        <h1 class="font-medium text-xl">
          <b class="font-bold poppins mr-0"
            ><span class="hidden md:inline-block">яegiszaum</span>
            <span class="font-bold poppins mr-0 md:hidden inline-block">я</span></b
          >
          <span class="font-bold poppins ml-0 hidden md:inline-block">.dev </span>
        </h1>
      </div>
        ...
        <a
          ...
          <button
            ...
            <h2 class="relative z-9 md:whitespace-normal whitespace-nowrap">
              <Icon
                class="mr-1 text-white dark:text-slate-600"
